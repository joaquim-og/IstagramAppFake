...
public class CustomDialog extends Dialog {
    ...
    public void addButton(final View.OnClickListener listener, @StringRes int... texts) {
        textViews = new TextView[texts.length];

        for (int i = 0; i < texts.length ; i++) {
            TextView textView = new TextView(new ContextThemeWrapper(getContext(), R.style.instaFormTextViewBaseDialog), null, 0);
